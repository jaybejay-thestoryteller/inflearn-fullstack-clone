...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/jaewoos/dev/inflearn-fullstack-clone/frontend/prisma/.node-modules/.prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/jaewoos/dev/inflearn-fullstack-clone/frontend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineSchemaHash": "c0be9c7f26dc3019b580d4052ba5954b087210696f861f8ef1542beef8c13a8d",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/.node-modules/.prisma/client",
...
path.join(process.cwd(), "prisma/.node-modules/.prisma/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/.node-modules/.prisma/client/schema.prisma")
